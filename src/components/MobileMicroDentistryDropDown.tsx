...
const MobileMicroDentistryDropdown = ({ onClick }: MobileServicesDropdownProps) => {
...
useEffect(() => {
    ...
    const GITHUB_URL =
      'https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/home/microdentistry-menu.json';
    const LOCAL_URL = '/data/home/microdentistry-menu.json';
  ...
  return (
    <div className="w-full" ref={dropdownRef}>
      ...
      >
        <span className="font-medium">Dentistry</span>
        <svg
...
export default MobileMicroDentistryDropdown;