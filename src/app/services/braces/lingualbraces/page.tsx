...
export default function LingualBracesPage() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/service/braces/lingualbraces.json";

      const LOCAL_URL = "/data/service/braces/lingualbraces.json";
