...
export default function LigatingBracesPage() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/service/braces/ligatingbraces.json";

      const LOCAL_URL = "/data/service/braces/ligatingbraces.json";
