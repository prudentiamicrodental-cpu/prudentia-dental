...
export default function CeramicBracesPage() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/service/braces/invisalign.json";

      const LOCAL_URL = "/data/service/braces/invisalign.json";
