...
const EMPTY_DATA: LooseTeethData = {
...
const LooseTeethTreatmentPage = () => {
  const [data, setData] = useState<LooseTeethData>(EMPTY_DATA);
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/service/cosmetic/loose-teeth.json";

      const LOCAL_URL = "/data/service/cosmetic/loose-teeth.json";
      ...
      try {
        ...
        const data: LooseTeethData = await res.json();
        setData(data);
      } catch (error) {
        ...
        try {
          ...
          const localData: LooseTeethData = await localRes.json();
          setData(localData);
        } catch (localError) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen overflow-hidden bg-gradient-to-b from-purple-50 to-white">
                ...
                <div className="relative h-64 sm:h-80 md:h-96 w-full rounded-xl shadow-lg mb-4 overflow-hidden">
                  {hero.image && (
                    <Image
                      ...
                      src={hero.image}
                      alt="Loose teeth treatment at Prudentia Micro Dental Care"
                      fill
        ...
        {/* What Is Loose Teeth Treatment Section */}
                  ...
                  {whatIsSection.images.map((image, index) => (
                    <div key={index} className="relative h-48 sm:h-56 md:h-64 w-full rounded-xl overflow-hidden shadow-lg">
                      <Image
                        urlEndpoint={process.env.NEXT_PUBLIC_IMAGEKIT_URL_ENDPOINT}
                        src={image}
                        alt="Dental examination for loose teeth diagnosis"
                        fill
                ...
                <div className="relative h-64 sm:h-80 md:h-96 w-full rounded-xl overflow-hidden shadow-lg">
                  {whyChoose.image && (
                    <Image
                      urlEndpoint={process.env.NEXT_PUBLIC_IMAGEKIT_URL_ENDPOINT}
                      src={whyChoose.image}
                      alt="Why choose Prudentia for loose teeth treatment"
                      fill
                      sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 50vw"
                      className="object-cover"
                    />
                ...
                <div className="relative h-64 sm:h-80 md:h-96 w-full rounded-xl overflow-hidden shadow-lg">
                  {processing.image && (
                    <Image
                      ...
                      alt="Loose teeth treatment procedure"
                      fill
                      sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 50vw"
                      className="object-cover"
                    />
...
export default LooseTeethTreatmentPage;