...
const DentalVeneersPage = () => {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/service/cosmetic/veneers.json";

      const LOCAL_URL = "/data/service/cosmetic/veneers.json";
          ...
          >
            ...
            <div className="relative h-80 md:h-96 max-w-full shadow-2xl rounded-xl shadow-lg mb-8">
              <Image
                ...
                alt="Dental veneers smile transformation"
                fill
            ...
            <div className="lg:order-first">
              <div className="relative h-80 md:h-96 max-w-full shadow-2xl rounded-xl shadow-lg mb-8">
                ...
                <Image
                  ...
                  alt="Cosmetic concerns veneers can correct"
                  fill
                  className="object-contain"
                  priority
                />
            ...
            <div>
              <div className="relative h-80 md:h-96 max-w-full shadow-2xl rounded-xl shadow-lg mb-8">
                <Image
                  ...
                  alt="Veneers treatment procedure"
                  fill
                  className="object-contain"
                  priority
                />
            ...
            <div>
              ...
              <div className="relative h-80 md:h-96 max-w-full shadow-2xl rounded-xl shadow-lg mb-8">
                <Image
                  ...
                  alt="Is veneers treatment right for you"
                  fill
                  className="object-contain"
                  priority
                />
