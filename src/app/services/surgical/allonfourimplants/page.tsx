...
useEffect(() => {
    ...
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/service/surgical/allonfour.json";
      const LOCAL_URL = "/data/service/surgical/allonfour.json";
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50">
      <Head>
        <title>{data.meta?.title || 'All-on-4 Dental Implants'}</title>
              ...
              {data.whyChooseClinic?.image && (
                <div className="max-w-3xl mx-auto relative h-80 md:h-96 w-full rounded-xl overflow-hidden shadow-lg mb-8">
                  <Image
                    ...
                    alt="Prudentia Micro Dental Care All-on-4 implant technology"
                    fill
                    className="object-contain"
                    priority
                  />
                  ...
                  <div className="bg-white rounded-2xl shadow-xl overflow-hidden relative h-80 md:h-96 w-full">
                    {data.whoCanBenefit.image && (
                      <Image
                        ...
                        alt="Candidate for All-on-4 dental implants"
                        fill
                        className="object-contain"
                        priority
                      />
              ...
              {data.benefits?.image && (
                <div className="max-w-3xl mx-auto relative h-80 md:h-96 w-full rounded-xl overflow-hidden shadow-lg mb-8">
                  <Image
                    ...
                    alt="Benefits of All-on-4 dental implants"
                    fill
                    className="object-contain"
                    priority
                  />
