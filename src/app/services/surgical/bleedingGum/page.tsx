...
const BleedingGumsTreatmentPage = () => {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/service/surgical/bleedingGum.json";

      const LOCAL_URL = "/data/service/surgical/bleedingGum.json";
...
export default BleedingGumsTreatmentPage;