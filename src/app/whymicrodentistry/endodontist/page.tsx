...
export default function EndodontistNearMe() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/whymicrodentistry/endodontist.json";

      const LOCAL_URL = "/data/whymicrodentistry/endodontist.json";
