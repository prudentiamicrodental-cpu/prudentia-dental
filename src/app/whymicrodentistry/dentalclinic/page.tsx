...
export default function CosmeticNearMe() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/whymicrodentistry/dentalclinic.json";

      const LOCAL_URL = "/data/whymicrodentistry/dentalclinic.json";
