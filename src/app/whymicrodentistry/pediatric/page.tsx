...
export default function PediatricNearMe() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/whymicrodentistry/pediatric.json";

      const LOCAL_URL = "/data/whymicrodentistry/pediatric.json";
