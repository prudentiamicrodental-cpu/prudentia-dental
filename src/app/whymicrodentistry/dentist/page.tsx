...
export default function DentistNearMe() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/whymicrodentistry/dentist.json";

      const LOCAL_URL = "/data/whymicrodentistry/dentist.json";
