...
export default function PeriodontistNearMe() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/whymicrodentistry/periodontist.json";

      const LOCAL_URL = "/data/whymicrodentistry/periodontist.json";
