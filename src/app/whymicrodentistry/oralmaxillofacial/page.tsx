...
export default function OralMaxillofacialNearMe() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/whymicrodentistry/oralmaxillofacial.json";

      const LOCAL_URL = "/data/whymicrodentistry/oralmaxillofacial.json";
