...
export default function OrthodontistNearMe() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/whymicrodentistry/orthodontist.json";

      const LOCAL_URL = "/data/whymicrodentistry/orthodontist.json";
