...
export default function EmergencyNearMe() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/whymicrodentistry/emergency.json";

      const LOCAL_URL = "/data/whymicrodentistry/emergency.json";
