...
export default function ProstrhodontistNearMe() {
  ...
  useEffect(() => {
    async function loadData() {
      const GITHUB_URL =
        "https://raw.githubusercontent.com/prudentiamicrodental-cpu/Content/main/whymicrodentistry/prosthrodontist.json";

      const LOCAL_URL = "/data/whymicrodentistry/prosthrodontist.json";
